...
public class UsePersonAndMenstruationController {
	...
	public ResponseEntity<?> modifyMenstruationPeriod(
		...
		@RequestBody MenstruationDto.Create mensttCreateDto) {

		log.debug("[modifyMenstruationPeriod] usePersonId: {} mensttCreateDto: {}",usePersonId, mensttCreateDto);
		CommonResponseDto<?> responseDto = usePersonAndMenstruationService.createMenstruationInfo(usePersonId, mensttCreateDto);
